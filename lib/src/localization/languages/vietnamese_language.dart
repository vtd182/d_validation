      ...
      : super(
          {
            ...
            Language.code.validCEP: "'{PropertyName}' không phải là mã bưu điện (CEP) hợp lệ.",
            Language.code.validCPF: "'{PropertyName}' không phải là số CPF hợp lệ.",
            Language.code.validCNPJ: "'{PropertyName}' không phải là số CNPJ hợp lệ.",
            Language.code.validCreditCard: "'{PropertyName}' không phải là số thẻ tín dụng hợp lệ.",
